...
use Stagehand\Sessions\SessionExecuteParams\AgentConfig\ExecutionModel\AzureEntraModelConfigObject\ProviderOptions\Azure;

/**
 * Azure provider-specific model configuration.
 *
 * @phpstan-import-type AzureShape from \Stagehand\Sessions\SessionExecuteParams\AgentConfig\ExecutionModel\AzureEntraModelConfigObject\ProviderOptions\Azure
 *
