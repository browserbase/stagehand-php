...
namespace Stagehand\Sessions\SessionExecuteParams\AgentConfig\Model\AzureAPIKeyModelConfigObject;

use Stagehand\Core\Attributes\Required;
use Stagehand\Core\Concerns\SdkModel;
use Stagehand\Core\Contracts\BaseModel;
use Stagehand\Sessions\SessionExecuteParams\AgentConfig\Model\AzureAPIKeyModelConfigObject\ProviderOptions\Azure;

/**
 * Azure provider-specific model configuration.
 *
 * @phpstan-import-type AzureShape from \Stagehand\Sessions\SessionExecuteParams\AgentConfig\Model\AzureAPIKeyModelConfigObject\ProviderOptions\Azure
 *
