...
namespace Stagehand\Sessions\SessionStartParams\ModelClientOptions\BedrockAwsCredentialsModelClientOptions;
...
/**
 * @phpstan-type ProviderOptionsShape = array{
 *   accessKeyID: string,
 *   region: string,
...
final class ProviderOptions implements BaseModel
{
     ...
     * ```
     * ProviderOptions::with(accessKeyID: ..., region: ..., secretAccessKey: ...)
     * ```
     *
