...
namespace Stagehand\Sessions\SessionObserveParams\Options\Model\AzureEntraModelConfigObject;

use Stagehand\Core\Attributes\Required;
use Stagehand\Core\Concerns\SdkModel;
use Stagehand\Core\Contracts\BaseModel;
use Stagehand\Sessions\SessionObserveParams\Options\Model\AzureEntraModelConfigObject\ProviderOptions\Azure;

/**
 * Azure provider-specific model configuration.
 *
 * @phpstan-import-type AzureShape from \Stagehand\Sessions\SessionObserveParams\Options\Model\AzureEntraModelConfigObject\ProviderOptions\Azure
 *
